<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VisualizarSolicitudesVacaciones.aspx.cs" Inherits="Diseño.Visualizar_Vacaciones_Permisos.VisualizarSolicitudesVacaciones" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div>
    <h2 align="center"> Solicitudes de Vacaciones</h2>
    </div>
    <p>
        <br />
    </p>
            ...
            <tr>
                <td align="right">
                    <asp:Button ID="botonRegresar" runat="server" Text="Regresar" 
                        onclick="botonRegresar_Click" Height="25px" style="margin-left: 46px" 
                        Width="145px" />
                </td>
            </tr>
        </table>
