<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ModificarDepartamento.aspx.cs" Inherits="Diseño.Gestión_Departamentos.ModificarDepartamento" %>
    ...
    <div>
        <table style="width:121%;">
          <tr align="left">
            ...
            <tr align="left">
                <td class="style2" align="right">
                    <asp:Label ID="Label3" runat="server" Text="Pertenece a:"></asp:Label>
                    </td>
            ...
            <tr align="left">
                ...
                <td class="style1" style="margin-left: 160px">
                    <asp:Button ID="botonAplicarModificacion" runat="server" 
                        ...
                        Height="25px" style="margin-left: 20px" Width="145px" />
                </td>
                <td>
                    &nbsp;</td>
            </tr>
            ...
            <tr align="left">
                ...
                <td>
                    <asp:Button ID="botonRegresar" runat="server" Text="Regresar" 
                            onclick="botonRegresar_Click" Height="25px" style="margin-left: 58px" 
                        Width="145px" />
                </td>
            </tr>
        </table>
